    ...
    for row in sheet.values:
        ...
        for input_value in row:
            if row_num > 6 and col_num == 6:
                ws_c.cell(row=row_num, column=sheet_num+1, value=input_value)
            col_num += 1
        row_num += 1
    sheet_num += 1 
ws_c.cell(row=3, column=1, value="飲料売上レポート (2月 第1週) ※税込金額")
data_1 = Reference(ws_b, min_col=1, min_row=7, max_col=ws_b.max_column, max_row=ws_b.max_row)
label_1 = Reference(ws_b, min_col=2, min_row=6, max_col=ws_b.max_column, max_row=6)
bar_1 = BarChart()
bar_1.type = "col"
bar_1.grouping = "stacked"
bar_1.overlap = 100
bar_1.add_data(data_1, from_rows=True, titles_from_data=True)
bar_1.set_categories(label_1)
bar_1.x_axis.title = "日付"
bar_1.y_axis.title = "売上金額（税抜）"
bar_1.title = "日別売上金額（税抜）"
bar_1.y_axis.scaling.max = 350000
bar_1.width = 16.5
bar_1.height = 14
ws_b.add_chart(bar_1, "A17")
data_2 = Reference(ws_c, min_col=1, min_row=7, max_col=ws_c.max_column, max_row=ws_c.max_row)
label_2 = Reference(ws_c, min_col=2, min_row=6, max_col=ws_c.max_column, max_row=6)
bar_2 = BarChart()
bar_2.type = "col"
bar_2.grouping = "stacked"
bar_2.overlap = 100
bar_2.add_data(data_2, from_rows=True, titles_from_data=True)
bar_2.set_categories(label_2)
bar_2.x_axis.title = "日付"
bar_2.y_axis.title = "売上金額（税込）"
bar_2.title = "日別売上金額（税込）"
bar_2.y_axis.scaling.max = 350000
bar_2.width = 16.5
bar_2.height = 14
ws_c.add_chart(bar_2, "A17")
